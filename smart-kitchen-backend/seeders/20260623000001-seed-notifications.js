...
module.exports = {
    async up(queryInterface) {
        const rows = [
            ...
            { notificationId: 2,  userId: 1,  type: "follow", message: "User 15 started following you.",           sourceUserId: 15, entityId: 15, entityType: "user",         isRead: true,  createdAt: ago(27),    updatedAt: ago(27) },
            { notificationId: 3,  userId: 1,  type: "follow", message: "User 17 started following you.",           sourceUserId: 17, entityId: 17, entityType: "user",         isRead: true,  createdAt: ago(27),    updatedAt: ago(27) },
            { notificationId: 4,  userId: 1,  type: "follow", message: "User 18 started following you.",           sourceUserId: 18, entityId: 18, entityType: "user",         isRead: true,  createdAt: ago(27),    updatedAt: ago(27) },
            { notificationId: 5,  userId: 1,  type: "follow", message: "User 19 started following you.",           sourceUserId: 19, entityId: 19, entityType: "user",         isRead: false, createdAt: ago(26),    updatedAt: ago(26) },
            ...
            { notificationId: 7,  userId: 5,  type: "follow", message: "User 14 started following you.",           sourceUserId: 14, entityId: 14, entityType: "user",         isRead: true,  createdAt: ago(26),    updatedAt: ago(26) },
            { notificationId: 8,  userId: 5,  type: "follow", message: "User 17 started following you.",           sourceUserId: 17, entityId: 17, entityType: "user",         isRead: false, createdAt: ago(25),    updatedAt: ago(25) },
            ...
            { notificationId: 10, userId: 6,  type: "follow", message: "User 14 started following you.",           sourceUserId: 14, entityId: 14, entityType: "user",         isRead: true,  createdAt: ago(25),    updatedAt: ago(25) },
            { notificationId: 11, userId: 6,  type: "follow", message: "User 15 started following you.",           sourceUserId: 15, entityId: 15, entityType: "user",         isRead: true,  createdAt: ago(25),    updatedAt: ago(25) },
            { notificationId: 12, userId: 6,  type: "follow", message: "User 16 started following you.",           sourceUserId: 16, entityId: 16, entityType: "user",         isRead: false, createdAt: ago(24),    updatedAt: ago(24) },
            { notificationId: 13, userId: 7,  type: "follow", message: "User 14 started following you.",           sourceUserId: 14, entityId: 14, entityType: "user",         isRead: true,  createdAt: ago(24),    updatedAt: ago(24) },
            { notificationId: 14, userId: 7,  type: "follow", message: "User 16 started following you.",           sourceUserId: 16, entityId: 16, entityType: "user",         isRead: false, createdAt: ago(24),    updatedAt: ago(24) },
            { notificationId: 15, userId: 8,  type: "follow", message: "User 15 started following you.",           sourceUserId: 15, entityId: 15, entityType: "user",         isRead: true,  createdAt: ago(24),    updatedAt: ago(24) },
            { notificationId: 16, userId: 8,  type: "follow", message: "User 19 started following you.",           sourceUserId: 19, entityId: 19, entityType: "user",         isRead: false, createdAt: ago(23),    updatedAt: ago(23) },
            ...
            { notificationId: 18, userId: 21, type: "follow", message: "User 14 started following you.",           sourceUserId: 14, entityId: 14, entityType: "user",         isRead: false, createdAt: ago(22),    updatedAt: ago(22) },
            { notificationId: 20, userId: 36, type: "follow", message: "User 16 started following you.",           sourceUserId: 16, entityId: 16, entityType: "user",         isRead: false, createdAt: ago(22),    updatedAt: ago(22) },

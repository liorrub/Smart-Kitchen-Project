    ...
    useEffect(() => {
        async function loadRecipes() {
            try {
                ...
                // Fetch reviews for all recipes to compute the system-wide average rating.
                // Runs after the main fetch so a review failure doesn't break the page.
                try {
                    const reviewsByRecipe = await Promise.all(
                        recipesData.map((recipe) => getRecipeReviews(recipe.recipeId))
                    );
                ...
                console.error("Recipe management loading error:", err);
        ...
        return (
            <div className="recipes-page">
                <div className="recipes-message-card">
                    ...
                    <p>
                        Please wait while we load all recipes in the system.
                    </p>
                </div>
            </div>
        );
    ...
    return (
        <div className="recipes-page">
                    ...
                    >
                        ...
                        <div className="recipe-management-modal-body">
                            <FormCard
                                ...
                                description={editingRecipe ? "Update the recipe details below." : "Fill in the recipe details. The recipe will be added to the system."}
            ...
            <PageHero
                ...
                description="View, edit and delete all recipes in the system."
                stats={[
                    {
            ...
            <section className="recipes-card">
                <div className="recipes-card-header">
                    <div>
                        ...
                        <p>
                            Manage all recipes across the system.
                        </p>
                    </div>
            ...
            {recipes.length === 0 ? (
                <section className="recipes-empty-state">
                    ...
                    <p>
                        No recipes have been added to the system yet.
                    </p>
                </section>
            ) : (
